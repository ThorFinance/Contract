...
contract ThorFinance is ERC20Detailed, Ownable {
    ...
    string public _name = "Thor Finance";
    string public _symbol = "THOR";
    ...
    uint256 public thorBankFee = 20;
    uint256 public nftHolderFee = 20;

    uint256 public sellFee = thorBankFee.add(nftHolderFee);
    ...
    address public thorBankReceiver;
    ...
    constructor() ERC20Detailed(_name, _symbol, uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x7e5ef64013Fa424B2CdF7207890ba3C11De258B8;
        treasuryReceiver = 0xBA1304CfA1eB1bd259b81774aFba3726722b4462;
        insuranceReceiver = 0xE53C7Eafd0730F7B044e1D77696a9Ce22009C7A9;
        thorBankReceiver = 0x9CeF7628162Fde453C188d6e23017811f2025326;
        nftHolderReceiver = 0x8BdCFeF2873F0DF8AcBc7982e6E80d9152a80948;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = thorBankFee.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(thorBankFee).add(nftHolderFee);
        ...
        (success, ) = payable(thorBankReceiver).call{
        value: currentBalance.mul(thorBankFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
